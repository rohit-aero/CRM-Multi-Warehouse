<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="rptDailyPurchase.aspx.cs" Inherits="Reports_rptDailyPurchase" %>
        ...
        <div class="row pt-3">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="form-group">
                    ...
                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="MM/dd/yyyy" PopupButtonID="txtFrom" TargetControlID="txtFrom"></asp:CalendarExtender>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="form-group">
                    ...
                    <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="MM/dd/yyyy" PopupButtonID="txtTo" TargetControlID="txtTo"></asp:CalendarExtender>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="form-group">
