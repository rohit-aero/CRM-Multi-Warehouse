...
public partial class Reports_frmContainerReport : System.Web.UI.Page
{
    ...
    private DataTable ReportData()
    {
        ...
        try
        {
            clscon.Return_DT(dt, "EXEC [dbo].[Get_ContainerJobs]");
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Qstr += "  SentDate    varchar(50),   Requestor   varchar(50),  Sourceid    varchar(10), OrderQty    int,   ";
            ...
            Qstr += " END AS Requestor, MIN(Inv_Source.[Source]) AS [Source],  MIN(Inv_ContainerDetail.OrderQty) AS OrderQty, ";
            ...
            Qstr += " LEFT JOIN Inv_Source ON Inv_Source.id=Inv_Container.Sourceid ";
            ...
            Qstr += "  OrderDate,  SentDate, Requestor,  Sourceid, OrderQty,  ShipQty,  CASE WHEN PendingQty<0 THEN 0 ELSE PendingQty  ";
    ...
    private DataTable ReportDataPendingQty()
    {
        ...
        try
        {
            clscon.Return_DT(dt, "EXEC [dbo].[Get_ManagePrepareContainerNew_PendingQty]");
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
