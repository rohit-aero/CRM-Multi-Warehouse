<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmAeroYTDComparisionReport - Copy.aspx.cs" Inherits="Reports_frmAeroYTDComparisionReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div style="text-align: center; display: none" id="divSalesRepbyAll" runat="server">
            <div class="col-sm-auto">
                <div class="form-group chosenFullWidth  text-left">
                    ...
                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlSaleRepAll" runat="server">
                        <asp:ListItem Value="0">All</asp:ListItem>
                        <asp:ListItem Value="1">Premier Marketing Group</asp:ListItem>
                        <asp:ListItem Value="2">Burlis-Lawson Group</asp:ListItem>
                        <asp:ListItem Value="3">PMR</asp:ListItem>
        ...
        <div style="text-align: center; display: none" id="divSalesHobart" runat="server">
            <div class="col-sm-auto">
                <div class="form-group chosenFullWidth  text-left">
                    ...
                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlHobartSalesRep" runat="server">
                        <asp:ListItem Value="0">Select</asp:ListItem>
        ...
        <div class="col-sm-12">
            <div class="form-group mb-0 flex-column">
                ...
                <div>
                    ...
                    <asp:Button ID="btnCancel" CssClass="btn btn-danger btn-sm" CausesValidation="false" runat="server" Text="Cancel" />
                </div>
            </div>
        </div>
    </div>
    ...
    <script language="javascript" type="text/javascript">
        function ShowHideDives() {
            ...
            showDivOpperByHoabrtNew(); showDivDealers();
        }
