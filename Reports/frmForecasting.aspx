<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmForecasting.aspx.cs" Inherits="Reports_frmForecasting" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="col-12">
                        <ul>
                          ...
                          <%--  <li>Project Parts Qty<strong> Greater Than Zero</strong>.</li>  --%>
                            ...
                            <li>Forecast Item<strong> Yes</strong>.</li>                                           
                        </ul>
                    </div>
                </div>
                </div>
            ...
            <div class="col-12 mt-3">
                <div class="table-responsive eoeTable" style="height: 750px">
                 ...
                 <div class="table-responsive eoeTable" style="height: 750px" id="divExportGrid" runat="server" visible="false">
                    <asp:GridView ID="gvExportGrid" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="verticalHeading mx-auto text-center"
                        EnableModelValidation="True" ShowFooter="true" OnDataBound="gvExportGrid_DataBound" OnRowDataBound="gvExportGrid_RowDataBound">
                    </asp:GridView>
                </div>
            </div>
        </ContentTemplate>
