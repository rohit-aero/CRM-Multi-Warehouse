<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="frmForecastingSubParts.aspx.cs" Inherits="Reports_frmForecastingSubParts" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-12 mt-3">
                <div class="table-responsive eoeTable" style="max-height: 750px">
                    <asp:GridView ID="gvSearchProject" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="mx-auto text-center"
