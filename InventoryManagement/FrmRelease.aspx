<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="FrmRelease.aspx.cs" Inherits="INVManagement_FrmRelease" %>
    ...
    <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <h4 class="title-hyphen position-relative">Release to Production</h4>
                </div>
            </div>
        </div>
    <div class="row">
        <div class="col-sm-6 mb-3">
         ...
         <div class="col-sm col-md col-lg col-xl-auto">
                <div class="row">
                    <div class="col-auto">
                        <asp:Button ID="btnRelease" runat="server" CssClass="btn btn-success btn-sm" Text="Release to Production" Enabled="false" OnClientClick="return confirm('Are you sure.?');" OnClick="btnRelease_Click" />
