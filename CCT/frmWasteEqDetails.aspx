<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmWasteEqDetails.aspx.cs" Inherits="CCT_frmWasteEqDetails" %>
                ...
                <div class="row">
                    ...
                    <div class="col-sm col-md col-lg col-xl">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <asp:Button ID="btnSave" CssClass="btn btn-success btn-sm" runat="server" Text="Save" OnClick="btnSave_Click" Visible="false" />
