<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmAeroQuotes.aspx.cs" Inherits="Reports_frmAeroQuotes" %>
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-auto">
                                            <div class="form-group">
                                                <label id="lblFrom">Quote Sent Date From</label>
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="form-group">
                                                <label id="lblTo">Quote Sent Date To</label>
                    ...
                    <div class="col-4">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 pt-2" runat="server" id="divQuote_HelpSection">
                                <div class="d-flex align-items-center mb-2">
                                    <h5>
                                        <strong>Aerowerks Quotes Report</strong>
                                    </h5>
                                </div>
                                <div class="col-12">
                                    <ul>
                                        <li>Date is based on <strong>Quote Sent Date</strong>.</li>
                                        <li>Bid Project <strong>is not Lost/Dead </strong>.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
