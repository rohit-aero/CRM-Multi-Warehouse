<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmRequisition - Copy.aspx.cs" Inherits="INVManagement_frmRequisition" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-danger btn-sm" CausesValidation="false" Text="Submit" Enabled="false" OnClientClick="return confirm('Are you sure to Submit this requisition.?');" OnClick="btnSubmit_Click" />
            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>Tentative Ship Date</label>
                ...
                <div class="row border-top pt-3">
                    <div class="col-sm-12">
                        <h5 class="text-uppercase">Requisition details with quantities</h5>
                         ...
                         <div class="col-sm-6 col-md-3 col-lg-2">
                            <div class="form-group">
                                <label>Search with Product Line</label>
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlSProduct" runat="server">                             
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlSPartNumber" DataTextField="InvSource" DataValueField="InvSourceid" runat="server">
                            </asp:DropDownList>
                        </div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>Search</label>
                            <asp:Button ID="btnSRep" CssClass="form-control btn btn-primary btn-sm" runat="server" Text="Search" />
                        </div>
                        </div>
                        </div>
                            ...
                            <div class="row pt-3">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvRequition" runat="server" AutoGenerateColumns="False" DataKeyNames="ReqDetailid"
                                            EnableModelValidation="True" ShowFooter="True" OnRowDeleting="gvRequition_RowDeleting" OnRowCommand="gvRequition_RowCommand">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Part#" HeaderStyle-Width="7%">
                                                    <FooterTemplate>
                                                        ...
                                                        <asp:Label ID="lblfooterpartno" runat="server" Text='<%# Eval("Partnumber") %>'></asp:Label>
                                                    </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Revision#" HeaderStyle-Width="5%">
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Description" HeaderStyle-Width="48%">
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Min" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Right">
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="In Hand" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Right">
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Order" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Right">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtqty" runat="server" Text='<%# Eval("PartQty") %>' autocomplete="off" CssClass="form-control form-control-sm text-right" onkeypress="return onlyDotsAndNumbers(this,event);"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="7%" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                ...
                <script type="text/javascript">
                    ...
                    function BindDrp() {
                        ...
                        $('#<%=ddlSProduct.ClientID%>').chosen();
                        $('#<%=ddlSPartNumber.ClientID%>').chosen();
