<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="rptProductionForecast.aspx.cs" Inherits="Reports_rptProductionForecast" %>
        ...
        <table style="width:85%;">
            <tr>
                ...
                <td>
                    ...
                    <%--<asp:Label ID="lblMsg" runat="server" Visible="true" Text="" ForeColor="Red"></asp:Label>--%>
              </td>
            </tr>
            </table>
        </fieldset>
