...
public partial class Reports_frmPurchaseHistory : System.Web.UI.Page
{
    BOLPurchaseHistory ObjBOL = new BOLPurchaseHistory();
    BLLPurchaseHistory ObjBLL = new BLLPurchaseHistory();
    ...
    private void Bind_Controls()
    {
        try
        {
            ...
            clscon.Return_DS(ds, "EXEC [dbo].[Get_PartsPurchaseHistory] 2,'" + null + "'");
    ...
    private DataTable Bind_Report()
    {
        ...
        try
        {
            ...
            {
                Qstr += " AND Vendor Like '" + ddlVendor.SelectedItem.Text + "'";
            }
            ...
            {
                Qstr += " AND ShipDate BETWEEN '" + txtFromDate.Text + "' AND '" + txtToDate.Text + "'";
            }
            ...
            ds = ObjBLL.GetPurchaseHistory(ObjBOL);
            if (ds.Tables[0].Rows.Count > 0)
            {
                dt = ds.Tables[0];
            }
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                rprt.Load(Server.MapPath("~/Reports/rptPartsPurchaseHistory.rpt"));
