<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="FrmIssueCategory.aspx.cs" Inherits="Administration_FrmIssueCategory" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Issue Category Information</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="row">
                            <div class="col-sm-auto mb-3">
                                <label class="mb-0">IssueCategory</label>
                            </div>
                            <div class="col-sm mb-3">
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlIssueCategory" runat="server" DataTextField="name" DataValueField="id" AutoPostBack="True" OnSelectedIndexChanged="ddlIssueCategory_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm col-md col-lg-auto">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <asp:Button CssClass="btn btn-secondary btn-sm" ID="btnBack" runat="server" Text="Customer CareTicket Page" />
                            </div>
