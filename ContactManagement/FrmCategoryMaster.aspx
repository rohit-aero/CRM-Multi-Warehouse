<%@ Page Title="" Language="C#" MasterPageFile="~/Settings.master" AutoEventWireup="true"
    CodeFile="FrmCategoryMaster.aspx.cs" Inherits="ContactManagement_FrmCategoryMaster" %>
                                         ...
                                         <tr>
                                                ...
                                                <td align="left" valign="top" class="w-25" style="width: 22%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                        ControlToValidate="txtCategoryName" ErrorMessage="*" ValidationGroup="chk"></asp:RequiredFieldValidator>
                                                </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="gv" Width="500px" runat="server" BackColor="#CCCCCC" BorderColor="#999999"
                                            ...
                                            AutoGenerateColumns="False" DataKeyNames="CategoryID" OnRowDeleting="gv_RowDeleting"
