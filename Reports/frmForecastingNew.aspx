<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmForecastingNew.aspx.cs" Inherits="Reports_frmForecastingNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <asp:Button CssClass="btn btn-success btn-sm" ID="btnGenrate" runat="server" Text="Preview" OnClick="btnGenrate_Click" />
                                        ...
                                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnMonthlyReport" CausesValidation="false" runat="server" Text="Monthly Report" OnClick="btnMonthlyReport_Click" />
            ...
            <asp:GridView ID="gvMonthlyExportToExcel" Style="display: none;" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="table mainGridTable table-sm mx-auto text-center"
                EnableModelValidation="True" ShowFooter="false" OnDataBound="gvMonthlyExportToExcel_DataBound" OnRowDataBound="gvMonthlyExportToExcel_RowDataBound">
            </asp:GridView>
        </ContentTemplate>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnGenerateExcel" />
            <asp:PostBackTrigger ControlID="btnExporttoPdf" />
            <asp:PostBackTrigger ControlID="btnMonthlyReport" />
        </Triggers>
    </asp:UpdatePanel>
