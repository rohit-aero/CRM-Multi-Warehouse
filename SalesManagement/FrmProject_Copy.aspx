<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="FrmProject_Copy.aspx.cs" Inherits="SalesManagement_FrmProject" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm chosenFullWidth">
                                        ...
                                        <asp:Panel ID="PanelJNum" runat="server" DefaultButton="SearchJNumberButton">
                                            <asp:TextBox ID="txtSearchPNum" AutoComplete="off" placeholder="Type Job Number" CssClass="form-control form-control-sm" runat="server">
                                            </asp:TextBox>
                    ...
                    <div class="col-sm-12 mt-3">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnSiteVisit" runat="server" CssClass="btn btn-info btn-sm mb-3" OnClick="btnSiteVisit_Click" Text="Site Visit" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group row">
                                    <asp:Label runat="server" ID="lblModels_New" Text="Model" class="col-12 mb-2"></asp:Label>
                                    <asp:Button ID="btnProposalRedirect" runat="server" CssClass="ml-3 btn btn-primary btn-sm" Text="Edit" OnClick="btnProposalRedirect_Click" />
                                </div>
                            </div>
