...
public partial class SalesManagement_FrmProject : System.Web.UI.Page
{
    ...
    private void FillDetailsFromJnumber(string strJNumber)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlPNumber.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ProposalID"]);

                ddlOASentTo.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["OASentTo"]);

                txtJobOrderDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["JobOrderDate"]));
                txtOrderAckDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["JobOrderAck"]));
                txtOADispatch.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["JobOADis"]));
                //if (ds.Tables[0].Rows[0]["OASentToContact"].ToString() != "")
                //{
                //    ddlContact.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["OASentToContact"]);
                //}
                //chkCanel.Checked = Convert.ToBoolean(ds.Tables[0].Rows[0]["CancelJob"]);
                ddlCustomer.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["CustomerID"]);
                txtPONumber.Text = Convert.ToString(ds.Tables[0].Rows[0]["PONumber"]);
                ...
                if (Convert.ToString(ds.Tables[0].Rows[0]["RepID"]) != "0")
                {
                ...
                int Consultantid = Convert.ToInt32(ds.Tables[0].Rows[0]["ConsultantID"]);
                //if (Consultantid != 0)
                //{
                //    GetConsultantMember(Consultantid);
                //    ddlConsultantMember.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ConsultantMemberID"]);
                //}
                //ddlDesigner.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ProjectDesignerID"]);
                ddlSalesSource.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["SalesSourceID"]);
                ddlServiceRep.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["SerRep"]);
                txtPoRecDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["PORec"]));
                if (Convert.ToInt32(ds.Tables[0].Rows[0]["OrderBelongsTo"]) == 1)
                {
                ...
                txtQuote.Text = Convert.ToString(ds.Tables[0].Rows[0]["QuoteSelected"]);
                //txtDateAssigned.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DateAssigned"]));
                ...
                ddlPreparedBy.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ProjDataPrepBy"]);
                ddlReviewedByAI.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ProjFormReviewByAI"]);
                txtReviewedByAI.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["PFRBAIDate"]));
                ddlReviewedByHO.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ProjFormReviewByHO"]);
                txtReviewedByHO.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["PFRBHODate"]));
                ...
                txtSpecAmount.Text = Convert.ToString(ds.Tables[0].Rows[0]["SpecCreditAmount"]);
                ...
                txtReleased.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ReleaseDate"]));
                txtFabReleasedDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ReleaseDate"]));
                txtExpectedArrivalDatefromChina.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ExpectedArrivalDatefromChina"]));
                txtDateBuiltDrgsSent.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DateAsBuiltDrgsSent"]));
                txtEstimatedCom.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["EstCompletionDate"]));
                txtActualCom.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ActualCompletionDate"]));
                txtTestRun.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["TestRunDate"]));
                var Reviewedby = Convert.ToString(ds.Tables[0].Rows[0]["ReviewedBy"]);
                ...
                if (ReviewedbyID.Contains(Reviewedby))
                {
                    ddlReviewedBy.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ReviewedBy"]);
                }
                ddlFabStatus.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["Status"]);
                ddlPurchasedItems.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["PurchasedItems"]);
                ddlPurchasedItemsCAD.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["PurchasedItemsCAD"]);
                ddlInstallationBy.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["InstallationBy"]);
                ddlInstallerA.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["InstallatorA"]);
                ddlInstallerB.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["InstallatorB"]);
                ddlInstallerC.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["InstallatorC"]);
                txtInstallationStart.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["InstallDate"]));
                txtInstallationEnd.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["InstallationCompletionDate"]));
                txtDemo.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DemoDate"]));
                txtWarrantyStart.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["WarrantyStartDate"]));
                txtWarrantyEnd.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["WarrantyEndDate"]));
                txtFollowUp.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["FollowUpDate"]));
                txtCarePack.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["CustCarePackageSendDate"]));
                txtManualsDisp.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ManualDispatchDate"]));
                txtTestRemarks.Text = Convert.ToString(ds.Tables[0].Rows[0]["Comments"]);
                if (Convert.ToInt32(ds.Tables[0].Rows[0]["PMPack"]) == 0)
                {
                ...
                //txtConsultantFeedback.Text = Convert.ToString(ds.Tables[0].Rows[0]["FeedBackConsultant"]);
                //txtDealerFeedback.Text = Convert.ToString(ds.Tables[0].Rows[0]["FeedBackDealer"]);
                //txtSummary.Text = Convert.ToString(ds.Tables[0].Rows[0]["SummofSugg"]);
                // Second Tab
                ddlCurrency.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["CurrencyID"]);
                txtEqPrice.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["Price"]).ToString("N");
                txtEqDiscount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["EqDiscount"]).ToString("N");
                txtEqDisAmount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["EqDisAmount"]).ToString("N");
                txtNetEqPrice.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["NetEqPrice"]).ToString("N");

                txtFreight.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["Freight"]).ToString("N");
                txtInstall.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["Installation"]).ToString("N");
                txtExWarranty.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["ExWarrantyPrice"]).ToString("N");
                //txtNetAmount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["NetAmount"]).ToString("F");
                txtNetAmount.Text = CalculateNetAmount().ToString("N");
                txtAmountInvoiced.Text = txtNetAmount.Text;
                txtHST.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["GST"]).ToString("N");
                txtTotalAmount.Text = Convert.ToDecimal(CalculateTotal()).ToString("N");
                txtinvnumber.Text = Convert.ToString(ds.Tables[0].Rows[0]["InvoiceNumber"]);
                txtInvodate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DateInvoiceSent"]));
                txtChequeNo.Text = Convert.ToString(ds.Tables[0].Rows[0]["AeroChequeNum"]);
                txtIndComDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["IndComDate"]));
                txtDateReceived.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DatePaymentReceived"]));
                txtDiscount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["discount"]).ToString("N");
                txtAmount.Text = Convert.ToDecimal(CalculateCommission()).ToString("N");
                ddlFOB.Text = Convert.ToString(ds.Tables[0].Rows[0]["fob"]);
                ddlTerm.Text = Convert.ToString(ds.Tables[0].Rows[0]["term"]);
                txtActualFreight.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["FreightPaid"]).ToString("N");
                ddlRate.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["CommissionType"]);
                txtProjectCommNotes.Text = Convert.ToString(ds.Tables[0].Rows[0]["CommissionText"]);
                //todo
                txtCommAmount.Text = Convert.ToDecimal(CalculateCommissionMain()).ToString("N");
                txtCommCheque.Text = Convert.ToString(ds.Tables[0].Rows[0]["KflexCheckNumber"]);
                txtCommDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DateCommissionPaid"]));
                string comtype = Convert.ToString(ds.Tables[0].Rows[0]["GSICommissionType"]);
                ...
                {
                    txtCommissionRate.Text = Convert.ToString(ds.Tables[0].Rows[0]["GSICommissionType"]);
                }
                txtCommissionAmount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["GSICommissionAmount"]).ToString("N");
                txtCommissionChequeNo.Text = Convert.ToString(ds.Tables[0].Rows[0]["GSICommissionCheckNo"]);
                txtCommissionDateSent.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["GSICommissionSentDate"]));
                //todo
                ddlShipper.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ShipperID"]);
                string sc = Convert.ToString(ds.Tables[0].Rows[0]["ShippingCommit"]);
                if (sc != " ")
                {
                    ddlShippingComit.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ShippingCommit"]);
                }
                else
                {
                ...
                //st = Convert.ToString(ds.Tables[0].Rows[0]["ShipStatus"]);
                //if (st !=" ")
                //{
                //    ddlShippingStatus.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ShipStatus"]);
                //}
                //else
                //{
                ...
                //var Temp = ds.Tables[0].Rows[0]["shipdate"];
                txtShipDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["projectshipdate"]));
                ...
                txtCompany.Text = Convert.ToString(ds.Tables[0].Rows[0]["ShipToName"]);
                txtAddress.Text = Convert.ToString(ds.Tables[0].Rows[0]["ShipToStreet"]);
                txtCity.Text = Convert.ToString(ds.Tables[0].Rows[0]["ShipToCity"]);
                ddlcountry.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["CountryID"]);
                GetState(ddlcountry.SelectedValue);
                if (Convert.ToString(ds.Tables[0].Rows[0]["ShipToState"]) != "")
                {
                    ddlState.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["ShipToState"]);
                }
                txtZip.Text = Convert.ToString(ds.Tables[0].Rows[0]["ShipToZipCode"]);
                txtContactPerson.Text = Convert.ToString(ds.Tables[0].Rows[0]["SiteContact"]);
                txtPhone.Text = Convert.ToString(ds.Tables[0].Rows[0]["SiteContactTelephone"]);
                txtSMCost.Text = Convert.ToString(ds.Tables[0].Rows[0]["ConCost"]);
                //todo
                txtRoyalAmount.Text = Convert.ToString(ds.Tables[0].Rows[0]["ConRoylAmt"]);
                txtCheq.Text = Convert.ToString(ds.Tables[0].Rows[0]["ConCheckNo"]);
                txtDatePaid.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ConChqPaidDt"]));
                txtConRoyalAmount.Text = Convert.ToString(ds.Tables[0].Rows[0]["ConRoylAmt"]);
                //ddlMfgFacility.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["MfgFacilityID"]);
                btnSave.Text = "Update";
                ...
                if (Convert.ToString(ds.Tables[0].Rows[0]["DealerID"]) == "814")
                {
                    txtCommissionRate.Text = "5";
                    txtCommissionAmount.Text = Convert.ToDecimal(Convert.ToDecimal(txtNetEqPrice.Text) * 5 / 100).ToString("N");
                }
                txtFabStartDate.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DateAssigned"]));
                ddlProjectDesigner.SelectedValue = ds.Tables[0].Rows[0]["ProjectDesignerID"].ToString();
                txtDueToCanda.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["DueDateCanada"]));
                txtFabtrication.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["FabSentToCanada"]));
                //if (ds.Tables[0].Rows[0]["EngineerCanada"].ToString() != "" && ds.Tables[0].Rows[0]["EngineerCanada"].ToString() != "Select")
                //{
                //    ddlProjectDesCanada.SelectedValue = ds.Tables[0].Rows[0]["EngineerCanada"].ToString();
                //}

                ddlManuFac.SelectedValue = ds.Tables[0].Rows[0]["MfgFacilityID"].ToString();
                txtReleasetoNesting.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ReleasedToNesting"]));
                txtProjectReleasedToShop.Text = cls.Converter(Convert.ToString(ds.Tables[0].Rows[0]["ReleasedToShop"]));
                ddlNestingStatus.SelectedValue = ds.Tables[0].Rows[0]["NestingStatus"].ToString();
                //if (ds.Tables[0].Rows[0]["JobType"].ToString() != "")
                //{
                //    ddlProjectType.SelectedIndex = ddlProjectType.Items.IndexOf(ddlProjectType.Items.FindByText(ds.Tables[0].Rows[0]["JobType"].ToString()));
                //}
                //if (ds.Tables[0].Rows[0]["ExistingJobID"].ToString() != "0")
                //{
                //    ddlExistingJobno.SelectedItem.Text = ds.Tables[0].Rows[0]["ExistingJobID"].ToString();
                //}
                if (ds.Tables[0].Rows[0]["ProjectStatus"].ToString() != "")
                {
                    ddlprojectstatus.SelectedValue = ds.Tables[0].Rows[0]["ProjectStatus"].ToString();
                }
                ddlProjectManager.SelectedValue = ds.Tables[0].Rows[0]["ProjectManager"].ToString();
                hfReleased.Value = ds.Tables[0].Rows[0]["ReleaseToShop"].ToString();
                txtCashDiscountAmount.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["CashDisAmt"]).ToString("N");
                decimal cashper = Convert.ToDecimal(ds.Tables[0].Rows[0]["CashDisPer"]);
                txtCashDiscountPer.Text = cashper.ToString("N");
                if (cashper <= 0)
                {
                    txtAmountForComision.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["NetEqPrice"]).ToString("N");
                    //txtTAmountRec.Text = txtNetAmount.Text;
                    txtTAmountRec.Text = txtTotalAmount.Text;
                }
                else
                {
                    txtAmountForComision.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["AmountForComission"]).ToString("N");
                    txtTAmountRec.Text = Convert.ToDecimal(ds.Tables[0].Rows[0]["CashAmtRec"]).ToString("N");
                }
                //ddlNestingStatus
    ...
    protected void ImgPNumber_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            {
                //Utility.ShowMessage(this, "PNumber not Found !!");
    ...
    private void Fill_ModelDetails()
    {
        try
        {
            ObjBOL1.Operation = 4;
            DataSet ds = new DataSet();
            ObjBOL1.PNumber = ddlPNumber.SelectedValue;
            ds = ObjBLL1.GetSubModel(ObjBOL1);
            if (ds.Tables[0].Rows.Count > 0)
            {
