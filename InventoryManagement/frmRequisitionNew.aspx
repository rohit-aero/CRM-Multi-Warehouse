               ...
               <div class="col-sm-3 col-md-3 col-lg-2">
                   ...
                   <div class="col-sm-2 col-md-3 col-lg-2">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="lblInStock" CssClass="form-control form-control-sm text-right"  runat="server" Enabled="false"></asp:TextBox>            
                        </div>
                    </div>
        ...
        <ItemTemplate>
            <asp:Label ID="lblShipById" runat="server" Text='<%# Eval("ShipBy") %>'>
                    ...
                    <asp:TemplateField HeaderText="In Stock" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:Label ID="lnkInStock" runat="server" Text='<%# Eval("InStock") %>' CausesValidation="false"></asp:Label>                                                            
                                    </ItemTemplate>
                                <HeaderStyle Width="5%" />
                ...
                <div class="position-relative h-100">   
                    ...
                    <div class="overflow-auto h-100">
                         <div class="col-12" style="position: sticky;top: 0; z-index: 107; background: white; padding: 10px;">
                            ...
                            <div class="col-12">
                            <div class="form-group">
                            <asp:Button ID="btnAddParts" CssClass="btn btn-success btn-sm" CausesValidation="false" runat="server" Text="Add Parts" OnClick="btnAddParts_Click">
                            </asp:Button>
                            </div>
                            </div>        
                            </div>   
                        ...
                        <asp:TemplateField HeaderText="Product Code" HeaderStyle-Width="5%">
                            <ItemTemplate><asp:Label ID="lblProductCode" runat="server" Text='<%# Eval("ProductCode") %>'>
                                </asp:Label>
                            </ItemTemplate>
                            <ItemStyle />
                            <HeaderStyle Width="5%" />
