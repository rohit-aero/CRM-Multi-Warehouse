<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmForecastingNew_Exclude.aspx.cs" Inherits="Reports_frmForecastingNew" %>
            ...
            <div class="col-12 mt-3">
                <div class="table-responsive eoeTable" style="height: 750px">
                    <asp:GridView  ID="gvSearch" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="table mainGridTable table-sm verticalHeading mx-auto text-center"
                     ...
                     <asp:GridView ID="gvExportToExcel" runat="server" CellPadding="3" EmptyDataText="No Items Found"
                AutoGenerateColumns="true" Style="height: 0px;"
                EnableModelValidation="True" ShowFooter="false" OnDataBound="gvExportToExcel_DataBound">
            </asp:GridView>
                </div>
            </div>
        </ContentTemplate>
