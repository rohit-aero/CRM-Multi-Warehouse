<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="FrmCountry.aspx.cs" Inherits="Administration_FrmCountry" %>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <h4 class="title-hyphen position-relative">Country Information</h4>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="col-12"><h5 class="text-uppercase">Country Information</h5></div>
