<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmForecasting_V1.aspx.cs" Inherits="Reports_frmForecasting_V1" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="row chosenFullWidth">
                                    ...
                                    <div class="col">
                                        <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlReportType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged">
                                            <asp:ListItem Value="D" Selected>Detail</asp:ListItem>
            ...
            <div class="col-12 mt-3">
                <div class="table-responsive eoeTable" style="height: 750px">
                    <asp:GridView ID="gvSearch" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="verticalHeading mx-auto text-center"
                        EnableModelValidation="True" ShowFooter="true" OnDataBound="gvSearch_DataBound" OnRowDataBound="gvSearch_RowDataBound">
                    </asp:GridView>
                </div>
                <div class="table-responsive eoeTable" style="height: 750px; display: none;">
                    <asp:GridView ID="gvExportToPDF" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="verticalHeading mx-auto text-center"
                        EnableModelValidation="True" ShowFooter="true" OnDataBound="gvExportToPDF_DataBound" OnRowDataBound="gvExportToPDF_RowDataBound">
                    </asp:GridView>
                </div>
                <div class="table-responsive eoeTable" style="height: 750px" id="dvSummary" runat="server" visible="false">
                    <asp:GridView ID="gvSummary" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="verticalHeading mx-auto text-center"
                        EnableModelValidation="True" ShowFooter="true" OnDataBound="gvSummary_DataBound" OnRowDataBound="gvSummary_RowDataBound">
                    </asp:GridView>
                </div>
            </div>
        </ContentTemplate>
