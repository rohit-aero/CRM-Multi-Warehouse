<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmPrepareContainer.aspx.cs" Inherits="InventoryManagement_frmPrepareContainer" %>
                ...
                <div class="row">
                    <div class="col-sm-7 col-md-6 col-lg-5 col-xl-5">
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md mb-2">
                            ...
                            <div class="col-sm-7 col-md mb-3">
...
<asp:GridView ID="gvMainRequisitionDetail" CssClass="table mainGridTable table-sm mb-0" DataKeyNames="PartId" runat="server" AutoGenerateColumns="False" EnableModelValidation="True">
    <Columns>
        <asp:TemplateField HeaderText="Part Number" HeaderStyle-Width="10%">
            <ItemTemplate>            
      ...
      <asp:TemplateField HeaderText="Part Desc" HeaderStyle-Width="18%">
            <ItemTemplate>  
                  ...
                  <asp:Label ID="lblContainerPOId" runat="server" Text='<%# Eval("POid") %>' Visible="false"></asp:Label> 
                          <asp:Label ID="lblContainerPODetailId" runat="server" Text='<%# Eval("PODetailid") %>' Visible="false"></asp:Label>                                                           
                            ...
                            <asp:TextBox ID="txtShippingQty" runat="server" autocomplete="off" CssClass="form-control form-control-sm text-right" 
                                Text='<%# Eval("ShippedQty") %>' 
                                onkeypress="return onlyDotsAndNumbers(this,event);" MaxLength="5" onpaste="return false"></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
