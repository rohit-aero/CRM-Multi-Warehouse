<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="RPTHOBARTSALES.aspx.cs" Inherits="Reports_rptHobartCanadaSales" %>
        ...
        <fieldset style="width: 90%; margin-top: 1%; margin-left: 2%;">
            ...
            <table style="width: 85%;">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnShow" runat="server" Text="Generate" OnClick="btnShow_Click" CausesValidation="False" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <%--            <tr>
