<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="FrmNonActiveReps.aspx.cs" Inherits="FrmNonActiveReps" %>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <h4 class="title-hyphen position-relative">Search Non Active Sales</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-7 col-md-8 col-lg-8 col-xl">
                ...
                <div class="col-sm-6 col-md mb-3">
				        <asp:DropDownList ID="ddlSalesRepGroup" CssClass="form-control form-control-sm" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSalesRepGroup_SelectedIndexChanged">
                        <asp:ListItem Value="-1">Select</asp:ListItem>
                        <asp:ListItem Value="10">Hobart (All Regions)</asp:ListItem>
                        <asp:ListItem Value="1">Burlis-Lawson Group</asp:ListItem>
                        <asp:ListItem Value="6">EPI</asp:ListItem>
                        <asp:ListItem Value="3">HRI</asp:ListItem>
                        <asp:ListItem Value="7">KLH</asp:ListItem>
                        <asp:ListItem Value="4">PBAC</asp:ListItem>
                        <asp:ListItem Value="2">PMR</asp:ListItem>
                        <asp:ListItem Value="0">Premier Marketing Group</asp:ListItem>
                        <asp:ListItem Value="9">Squier</asp:ListItem>
                        <asp:ListItem Value="5">Woolsey Associates</asp:ListItem>
                        <asp:ListItem Value="11">Tragenflex</asp:ListItem>
                        </asp:DropDownList>
               </div>
...
<asp:DropDownList CssClass="form-control form-control-sm" ID="ddlProductLine" runat="server">
<asp:ListItem></asp:ListItem>
<asp:ListItem Value="A">Aerowerks</asp:ListItem>
<asp:ListItem Value="T">Tragenflex</asp:ListItem>
