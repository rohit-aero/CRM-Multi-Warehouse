<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="FrmPartsInfo_CAD.aspx.cs" Inherits="INVManagement_FrmPartsInfo_CAD" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Project Parts Information (CAD)</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
