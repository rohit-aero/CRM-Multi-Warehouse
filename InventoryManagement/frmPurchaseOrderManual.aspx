        ...
        <ContentTemplate>
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnNotify" runat="server" CssClass="btn btn-danger btn-sm" CausesValidation="false" Text="Acknowledgement" Enabled="false" OnClientClick="return confirm('Are you sure you want to Notify.?');" OnClick="btnNotify_Click"  />
            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label style="color:red">Vendor*</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlSource" DataTextField="InvSource" DataValueField="InvSourceid" runat="server">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                                ...
                                <tr>   
                                    ...
                                    <td>
                                       <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlReqNumber" runat="server" DataTextField="ReqNumber" DataValueField="ReqID"
                                           AutoPostBack="true" OnSelectedIndexChanged="ddlReqNumber_SelectedIndexChanged">  </asp:DropDownList>
                                    </td>
                                    <td>
            ...
            <ItemStyle Width="80%" />
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                       ...
                       <h4><label class="mb-0 title-hyphen position-relative">Part Number:</label></h4>
                            </div>
                            <div class="col-sm-9 col-md mb-3 chosenFullWidth ">
                                <h4><asp:Label ID="lblPartNumber"  runat="server"></asp:Label></h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvInTransit" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="Container No" HeaderStyle-Width="5%">
                <ItemTemplate>
                   <asp:Label ID="lblContainerNo" runat="server" Text='<%# Eval("ContainerNo") %>'>
                     ...
                     <asp:TemplateField HeaderText="Tentative Ship Date" HeaderStyle-Width="5%">
                                            <ItemTemplate><asp:Label ID="lblTentativeShipdate" runat="server" Text='<%# Eval("TentativeShipDate","{0:MM/dd/yyyy}") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle />
                                            <HeaderStyle Width="5%" />
                ...
                <asp:LinkButton ID="LinkButton1" runat="server"></asp:LinkButton>      <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" TargetControlID="LinkButton2"
      ...
      <h4><label class="mb-0 title-hyphen position-relative">Part Number:</label></h4>
                            ...
                            <div class="col-sm-9 col-md mb-3 chosenFullWidth ">
                                <h4><asp:Label ID="lblInShopPartNumber"  runat="server"></asp:Label></h4>
                            </div>
                        </div>
                    </div>
                </div>
